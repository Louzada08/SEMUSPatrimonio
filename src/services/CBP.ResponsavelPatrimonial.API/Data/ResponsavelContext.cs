...
namespace CBP.ResponsavelPatrimonial.API.Data
{
  public sealed class ResponsavelContext : DbContext, IUnitOfWork
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.ApplyConfigurationsFromAssembly(typeof(ResponsavelContext).Assembly);
    }
